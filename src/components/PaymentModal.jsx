...
function PaymentModal(props) {
  ...
  // call function in the smart contract to send token
  // to fund the project
  async function sendFund() {
    ...
    try {
      ...
      await txn.wait();
      alert(`${amount} Scroll Succesfully funded`);
  ...
  return (
    <div className="modal">
      ...
      <div className="modalContent">
        <div className="paymentForm flex flex-col items-center">
          <label className="paymentLabel">Amount (Scroll)</label>
          <input
            type="number"
            name="payment"
            id="payment"
            className="payment"
            placeholder="Enter Scroll amount"
            min="1"
            step="1"
            value={amount}
