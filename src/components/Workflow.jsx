  ...
  return (
    <div className="mt-20">
      ...
      <div className="flex flex-wrap justify-center pb-10 mb-32">
        <div className="p-2 w-full lg:w-1/2 z-10 pointer-events-none" data-aos="fade-up">
          <img src={photo1} alt="Coding" />
        </div>
      ...
      <div className="flex flex-wrap justify-center pb-10 mb-32">
        ...
        <div className="pt-12 w-full lg:w-1/2">
          {checklistItems2.map((item, index) => (
            <div key={index} className="flex mb-10" data-aos="fade-right">
            <div className="text-orange-400 mx-6 bg-neutral-900 h-10 w-10 p-2 justify-center items-center rounded-full" data-aos="fade-right">
              <CheckCircle2 />
            </div>
            <div>
              <h5 className="mt-1 mb-2 text-3xl">{item.title}</h5>
