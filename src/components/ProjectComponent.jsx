  ...
  return (
    <>
      <div className="projectContainer flex justify-between bg-black/75 px-16 py-10 rounded-2xl">
        ...
        <h2 className="flex flex-col text-left m-2 text-3xl text-white w-full mt-6 my-2"><span className="text-xl text-neutral-500 mb-1"> Artist Description</span>{projectDetails.projectDescription}</h2>
        </div>
        <div className="w-2/3">  
...
<div className="remainingDaysContainer text-3xl w-full mx-2 mb-8">
            ...
            </div>            {/* <div className="progressBarContainer">
              <progress
                min="0"
                max="100"
                value="30"
            ...
            <div className="flex flex-col h-full justify-center items-center">
              <div>
                <h5 className="flex flex-col mt-1 text-center m-2 text-3xl text-neutral-500 "><span className="text-5xl bg-gradient-to-r from-orange-500 to-yellow-400 text-transparent bg-clip-text">{projectDetails.amountRaised / PRECISION}</span>Scroll</h5>
                <p className="text-md p-2 text-xl text-white text-center">
                pledged out of
                </p>                
                  <h5 className="flex flex-col mt-1 text-center m-2 text-xl text-neutral-500"><span className="text-xl text-orange-500">{projectDetails.fundingGoal / PRECISION}</span>Scroll</h5>
              </div>
            </div>
          </div>
          ...
          <div  className="w-full sm:w-1/2 lg:w-2/5 bg-zinc-950 px-5 py-4 rounded-lg bg-secondary-black bg-glow-custom-1">
            ...
            {/* <div className="fundingValue">
              <h2><span className="bg-gradient-to-r from-orange-500 to-yellow-400 text-transparent bg-clip-text">{projectDetails.amountRaised / PRECISION}</span> LineaETH</h2>
            </div>
            <p className="goalValueContainer">
              pledged out of goal{" "}
              <span className="goalValue text-xl text-orange-200">
                {projectDetails.fundingGoal / PRECISION} LineaETH
              </span>{" "}
            ...
            <div className="contributors w-full mt-12 my-2">
          
          {projectDetails.contributors.length > 0 ? (
            <>
                        <h3 className="flex flex-col text-left m-2 text-2xl text-white w-full mb-5 mt-7 overflow-hidden"><span className="text-xl text-neutral-500 mb-1"> Contributors</span></h3>
            ...
            {projectDetails.contributors.map((contributor, idx) => (
              <div
                className="tablerow darkRow flex flex-row"
                key={idx}
              >
                <div className="item border" style={{ width: "80px" }}>
                  {idx + 1 + "."}
