...
function ProfileComponent(props) {
  ...
  return (
    <div className="profileContainer flex flex-col px-12 py-10 bg-black w-full">
     {name=="" && <div className="profileHeadingContainer">
      <h3 className="flex flex-col text-left m-2 text-2xl text-white w-full my-2 mt-4 overflow-hidden"><span className="text-xl text-neutral-500 mb-1">Account Name</span>{name}</h3>
      </div>}
      <div className="profileAddressContainer">
      <h3 className="flex flex-col text-left m-2 text-3xl text-white w-full my-2 mt-4 overflow-hidden"><span className="text-xl text-neutral-500 mb-1">Account Address</span>{address}</h3>
      </div>
